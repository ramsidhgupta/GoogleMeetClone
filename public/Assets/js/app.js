var AppProcess = (function () {
  ...
  async function updateMediaSenders(track, rtp_senders) {
    for (var con_id in peers_connnection_ids) {
  ...
  async function videoProcess(newVideoState) {
    ...
    try {
      ...
      if (newVideoState == video_states.Camera) {
        ...
        vstream.oninactive = (e) => removeVideoStream(rtp_vid_senders);
        $("#ScreenShareOnOff").html(
          '<span class="material-icons">present_to-all</span><div>Present Now</div>'
        );
      }
  ...
  async function setConnection(connid) {
    ...
    peers_connnection_ids[connid] = connid;
  ...
  async function closeConnection(connid) {
    peers_connnection_ids[connid] = null;
...
var MyApp = (function () {
  ...
  function event_process_for_signaling_server() {
    ...
    socket.on("showChatMessage", function (data) {
      ...
      var div = $("<div>").html(
        "<span class='font-weight-bold mr-3' style='color:green'>" +
          data.from +
          "</span>" +
          ltime +
          "</br>" +
  ...
  function eventHandeling() {
    $("#btnsend").on("click", function () {
      ...
      var div = $("<div>").html(
        "<span class='font-weight-bold mr-3' style='color:blue'>" +
          user_id +
          " (ME)" +
          "</span>" +
          ltime +
  ...
  function addUser(other_user_id, connId, userNum) {
    ...
    $(".in-call-wrap-up").append(
      '<div class="in-call-wrap d-flex justify-content-between align-items-center mb-3" id="participant_' +
        connId +
        '"> <div class="participant-img-name-wrap display-center cursor-pointer"> <div class="participant-img"> <img src="public/Assets/images/other.png" alt="image" class="border border-secondary" style="height: 40px; width: 40px; border-radius: 50%"/> </div> <div class="participant-name ml-2">' +
        other_user_id +
  ...
  $(document).on("click", ".people-heading", function () {
    $(".chat-show-wrap").hide(500);
    $(".in-call-wrap-up").show(500);
    $(this).addClass("active");
    $(".chat-heading").removeClass("active");
  });
  $(document).on("click", ".chat-heading", function () {
    $(".chat-show-wrap").show(500);
    $(".in-call-wrap-up").hide(500);
    $(this).addClass("active");
